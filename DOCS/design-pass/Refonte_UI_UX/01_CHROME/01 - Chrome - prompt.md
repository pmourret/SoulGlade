...
5. La pastille « ADULTE ARMÉ » lit `sheet.nsfw`, déjà exposé par l'API. Aucun changement backend dans ce chantier.
6. Vérifie :
...
7. Un seul commit frontend pour l'écran. Message : `ui(chrome): graphite identity + category/module bars (design-pass screen-0)`.
